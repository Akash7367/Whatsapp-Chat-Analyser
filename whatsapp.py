import re
import pandas as pd
# file = open(r"C:\Users\akash\OneDrive\Desktop\coding\projects\Whatsapp chat\WhatsApp Chat with AI ML Information.txt",'r',encoding='utf-8')
# data=file.read()
# print(data)
def preprocess(data):
    pattern = r"\d{1,2}/\d{1,2}/\d{4},\s\d{1,2}:\d{1,2}\s-\s"
